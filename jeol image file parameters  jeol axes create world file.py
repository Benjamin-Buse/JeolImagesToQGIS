...
import pandas as pd
imagefileparameters=tkinter.filedialog.askopenfile(title="select .txt file for .jpg file")
...
f = open(imagefileparameters.name.split(".txt")[0]+".jpw", "w")
lineA="-"+str(mmPerPixel)
f.write(lineA)
f.write("\n")
f.write("0.00000000000000003")
f.write("\n")
f.write("0.00000000000000003")
f.write("\n")
f.write(str(mmPerPixel))
f.write("\n")
f.write(str(TLx))
f.write("\n")
f.write(str(TLy))
